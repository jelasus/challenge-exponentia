...
const Form = () => {
  ...
  return (
    <Fragment>
      <h1>Formulario de ficha de empresa</h1>
      <form className="col-lg-6 offset-lg-3">
        ...
        <div className="form-group mt-3">
          <label htmlFor="controlSelectCompanyType">Tipo de empresa</label>
          <select className="form-control" id="controlSelectCompanyType" name="companyType" onChange={handleInputChange}>
